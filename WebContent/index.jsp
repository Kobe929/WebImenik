...
<body>
	...
	<div class="container topnav">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand topnav" href="#">Web imenik</a>
		</div>
				...
				<div class="col-lg-12">
					<div class="intro-message">
						...
						<ul class="list-inline intro-social-buttons">
							<li><a href="login.jsp"
								class="btn btn-default btn-lg"> <span class="network-name">Login</span></a>
							</li>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<ul class="list-inline banner-social-buttons">
						<li><a href="https://fb.com/filip.dautovic"
							class="btn btn-default btn-lg"><i class="fa fa-facebook-square"></i>
								<span class="network-name"> Facebook</span></a></li>
						<li><a
							href="https://github.com/Kobe929/WebImenik"
							class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i>
								<span class="network-name">Github</span></a></li>
